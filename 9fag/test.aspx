<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="test.aspx.cs" Inherits="_9fag.test" %>
			...
			<!-- Banner -->
				<section id="banner">
					...
					<ul class="actions">
						...
						<li><a href="register.aspx" class="button">Register</a><asp:Button ID="Button1" runat="server" Text="Button" />
                        </li>
					</ul>
				</section>
